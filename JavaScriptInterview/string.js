...
// length use to know the length of string
...
// slice performed on the string str is not changed
console.log(str); // output == hello pepcoders

slicedStr = str.slice(6); //-> prints starting to end
console.log(slicedStr);

// 2) substring() method --> same as slice 
...
// indexOf method
// it give the index of character in a string
console.log(str.indexOf("2"));
console.log(indexOf("2",8)) //find 2 after 8 index 